...
description = "RSAmyMRI: a template for small scientific Python projects"
...
.. _README: https://github.com/uwescience/RSAmyMRI/blob/master/README.md

License
=======
``RSAmyMRI`` is licensed under the terms of the MIT license. See the file
...
URL = "http://github.com/uwescience/RSAmyMRI"
DOWNLOAD_URL = ""
LICENSE = "MIT"
AUTHOR = "Ariel Rokem"
...
VERSION = __version__
PACKAGE_DATA = {'RSAmyMRI': [pjoin('data', '*')]}
REQUIRES = ["numpy"]
PYTHON_REQUIRES = ">= 3.5"
