...
# -*- coding: utf-8 -*-
#
# RSAmyMRI documentation build configuration file, created by
...
latex_documents = [
  ('index', 'RSAmyMRI.tex', 'RSAmyMRI Documentation',
   'Ariel Rokem', 'manual'),
]
...
man_pages = [
    ('index', 'RSAmyMRI', 'RSAmyMRI Documentation',
     ['Ariel Rokem'], 1)
]
...
texinfo_documents = [
  ('index', 'RSAmyMRI', 'RSAmyMRI Documentation',
   'Ariel Rokem', 'RSAmyMRI', 'One line description of project.',
   'Miscellaneous'),
]
